...
public class MyRetailControllerTest {
    ...
    public void testGetProduct_productValid_successful() throws Exception {
        ...
        ResponseEntity<ProductData> responseEntity = myRetailController.getProductDetails("1");
    ...
    public void testGetProduct_productNotFoundInDataStore_throwsProductNotFoundException() throws Exception {
        ...
        ProductNotFoundException ex = Assertions.assertThrows(ProductNotFoundException.class, () -> myRetailController.getProductDetails("1"));
    ...
    public void testGetProduct_jsonProcessingException_throwsCustomException() throws Exception {
        ...
        CustomException ex = Assertions.assertThrows(CustomException.class, () -> myRetailController.getProductDetails("1"));
